import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, d as renderHead, e as renderSlot, m as maybeRenderHead, f as renderComponent } from '../astro.78e45d11.mjs';
import 'html-escaper';
...
}, "/Users/ben/ampt/ampt-templates/astro/src/layouts/Layout.astro", void 0);
...
}, "/Users/ben/ampt/ampt-templates/astro/src/components/Card.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<main class="astro-J7PV25F6">
    ...
    <h1 class="astro-J7PV25F6">
      Welcome to <span class="text-gradient astro-J7PV25F6">Astro</span> on <span class="text-gradient astro-J7PV25F6">Ampt</span>!
    </h1>
    <p class="instructions astro-J7PV25F6">
      ...
      <strong class="astro-J7PV25F6">Code Challenge:</strong> Tweak the "Welcome to Astro on Ampt" message
      above.
    </p>
    <ul role="list" class="link-card-grid astro-J7PV25F6">
      ...
      ${renderComponent($$result2, "Card", $$Card, { "href": "https://getampt.com/docs", "title": "Ampt Docs", "body": "Check out Ampt's documentation to full utilize Ampt's features", "class": "astro-J7PV25F6" })}
...
` })}`;
}, "/Users/ben/ampt/ampt-templates/astro/src/pages/index.astro", void 0);

const $$file = "/Users/ben/ampt/ampt-templates/astro/src/pages/index.astro";
const $$url = "";
